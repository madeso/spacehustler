...
IF(WIN32)
	IF(ASSIMP_INCLUDE_DIR AND ASSIMP_LIBRARY_RELEASE)
		...
		IF(ASSIMP_LIBRARY_DEBUG)
			SET(ASSIMP_LIBRARIES debug ${ASSIMP_LIBRARY_DEBUG} ${ASSIMP_ZLIB_LIBRARY_DEBUG} optimized ${ASSIMP_LIBRARY_RELEASE} ${ASSIMP_ZLIB_LIBRARY_RELEASE})
		ELSE(ASSIMP_LIBRARY_DEBUG)
			SET(ASSIMP_LIBRARIES ${ASSIMP_LIBRARY_RELEASE} ${ASSIMP_ZLIB_LIBRARY_RELEASE})
...
mark_as_advanced(ASSIMP_LIBRARY_DEBUG ASSIMP_LIBRARY_RELEASE ASSIMP_ZLIB_LIBRARY_DEBUG ASSIMP_ZLIB_LIBRARY_RELEASE ASSIMP_INCLUDE_DIR)