...
// definitions shamelessly stolen from flew headers
/* <winnt.h> */
#ifndef CALLBACK
...
void CALLBACK MyDebugCallback(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, GLvoid* userParam)
{
