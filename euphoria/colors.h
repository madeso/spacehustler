...
/** @file
Utility code for genrating colors.
 */

#ifndef EUPHORIA_COLORS_H_
#define EUPHORIA_COLORS_H_
...
namespace colors {
  ...
  */
  ...
  /** Returns the color Medium Aqua Marine.
  @returns the color Medium Aqua Marine.
  */
  ...
  */
  ...
  /** Returns the color Fire Brick.
  @returns the color Fire Brick.
  */
  Color FireBrick();

  /** Returns the color Dark Golden Rod.
  @returns the color Dark Golden Rod.
  */
  Color DarkGoldenRod();
  ...
  */
  ...
  /** Returns the color Pale Golden Rod.
  @returns the color Pale Golden Rod.
  */
  Color PaleGoldenRod();
  ...
  */
  ...
  /** Returns the color Light Golden Rod Yellow.
  @returns the color Light Golden Rod Yellow.
  */
