...
class Color {
  public:
    ...
    @param G the green, ranging from 0 to 1.
    @param B the blue, ranging from 0 to 1.
    @param A the alpha, ranging from 0 to 1 where 0 ins transparent and 1 is solid.
     */
    ...
    /** The Alpha component., ranging from 0 to 1 where 0 ins transparent and 1 is solid.
     */
    float a;
};
